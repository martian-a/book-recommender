...
public class GoogleApiRequest extends ApiRequest {

	/*
	 * public GoogleApiRequest(HashMap<String, String> currParameters) {
	 * super(currParameters); }
	 */

	public GoogleApiRequest(String currMethod, HashMap<String, String> currParameters, String relativePath) {
